...
export default class BathroomsSlashCommand extends SlashCommand {
    public static readonly data = bathroomsData;
    private currentPage = 0;
    private embedsPerPage = 1;
    private orderBy: 'createdAt' | 'updatedAt' | 'campus' | 'institute' | 'avarageGrade' | 'avarageCleaningGrade' = 'createdAt';
    private order: 'ascending' | 'descending' = 'descending';
    private bathrooms?: Collection<string, BathroomWithAvaliations>;
    private paginatedEmbeds?: EmbedBuilder[][];
    ...
    private async paginatedEmbedsFactory() {
    ...
    private bathroomsSorter(first: BathroomWithAvaliations, second: BathroomWithAvaliations) {
    ...
    private rowPaginationComponentsFactory() {
        ...
        function currentPageButtonFactory(this: BathroomsSlashCommand) {
        ...
        function backward10ButtonFactory(this: BathroomsSlashCommand) {
            return new ButtonBuilder()
        ...
        function backwardButtonFactory(this: BathroomsSlashCommand) {
            return new ButtonBuilder()
        ...
        function forwardButtonFactory(this: BathroomsSlashCommand) {
            return new ButtonBuilder()
                .setCustomId('forward')
                .setLabel('>> 1')
                .setStyle(ButtonStyle.Secondary)
        ...
        function forward10ButtonFactory(this: BathroomsSlashCommand) {
            return new ButtonBuilder()
    ...
    private rowItemsPerPageComponentsFactory() {

        return new ActionRowBuilder<SelectMenuBuilder>()
            .setComponents(itemsPerPageSelectMenuFactory.bind(this)());


        function itemsPerPageSelectMenuFactory(this: BathroomsSlashCommand) {
    ...
    private rowOrderByComponentsFactory() {
        return new ActionRowBuilder<SelectMenuBuilder>()
            .setComponents(
                orderBySelectMenuFactory.bind(this)()
            );

        function orderBySelectMenuFactory(this: BathroomsSlashCommand) {
            return new StringSelectMenuBuilder()
    ...
    private rowOrderComponentsFactory() {
        return new ActionRowBuilder<SelectMenuBuilder>()
            .setComponents(
                orderSelectMenuFactory.bind(this)()
            );

        function orderSelectMenuFactory(this: BathroomsSlashCommand) {
