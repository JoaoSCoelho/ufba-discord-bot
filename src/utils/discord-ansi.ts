...
/**
 * THIS CODE IS A ADAPTATION FOR LIBRARY discord-ansi@1.0.0
 * ALL RIGHTS RESERVED TO LIBRARY AUTHOR alighamdan (laali)
 * SEE THE ORIGINAL CODE IN https://github.com/alighamdan/discord-ansi
 */
...
export class Ansi {
    ...
    constructor(
       ...
       */
        public fg: 0 | 30 | 31 | 32 | 33 | 34 | 35 | 36 | 37 = 0,
        /**
       ...
       */
        public bg: 40 | 41 | 42 | 43 | 44 | 45 | 46 | 47 | undefined = undefined
    ) {
        this.style = `\u001b[${this.type}${this.fg ? `;${this.fg}` : ''}${this.bg ? ';' + this.bg : ''
        }m`;
    }
     ...
     * @returns {string}
     */
    toAnsi(str: string | string[], reset: boolean) {
        if (Array.isArray(str)) str = str.join(' ');
        this.style = `\u001b[${this.type}${this.fg ? `;${this.fg}` : ''}${this.bg ? ';' + this.bg : ''
        }m`;
        
        const returnString = `${this.style}${str}${reset ? '\u001b[0m' : ''}`;
    ...
    /**
     * this will set default for fg (font color)
     */
    default() {
        this.fg = 0;
        this.style = `\u001b[${this.type}${this.fg ? `;${this.fg}` : ''}${this.bg ? ';' + this.bg : ''
    ...
    /** @protected */
    print() {
        const func = (...str: string[]) => this.toAnsi(str, true);
        this.style = `\u001b[${this.type}${this.fg ? `;${this.fg}` : ''}${this.bg ? ';' + this.bg : ''
        }m`;
